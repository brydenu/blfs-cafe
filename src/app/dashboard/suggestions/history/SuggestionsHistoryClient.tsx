...
export default function SuggestionsHistoryClient({ suggestions }: SuggestionsHistoryClientProps) {
  ...
  return (
    ...
    <div className="min-h-screen relative overflow-hidden flex justify-center p-4">
      ...
      {/* --- CONTENT CONTAINER --- */}
      <div className="relative z-10 w-full max-w-3xl space-y-6 pt-8 pb-12 px-2 sm:px-0">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            ...
            <div className="flex gap-2 sm:gap-3 flex-shrink-0">
              <Link href="/dashboard/suggestions">
                <button className="bg-[#32A5DC] hover:bg-[#288bba] text-white px-3 sm:px-5 py-2 sm:py-2.5 rounded-xl font-bold text-xs sm:text-sm shadow-md transition-all hover:scale-[1.02] active:scale-[0.98] whitespace-nowrap">
        ...
        {suggestions.length === 0 ? (
          <div className="bg-white rounded-3xl shadow-2xl p-8 border border-white/10 text-center">
            ...
            <Link href="/dashboard/suggestions">
              <button className="bg-[#32A5DC] hover:bg-[#288bba] text-white font-bold py-3 px-6 rounded-xl transition-all hover:scale-[1.02] active:scale-[0.98]">
                      ...
                      >
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <button
                            ...
                            disabled={isDeleting}
                            className="text-red-500 hover:text-red-700 transition-all active:scale-90 shrink-0 disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            {olderSuggestions.length > 0 && (
              <div>
                <button
                  ...
                  className="w-full bg-white rounded-2xl shadow-lg p-5 border border-white/10 text-left hover:bg-gray-50 transition-all active:scale-[0.98]"
                >
