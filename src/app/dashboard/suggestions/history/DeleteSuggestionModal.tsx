...
export default function DeleteSuggestionModal({
  ...
  const preview = suggestionContent && suggestionContent.length > 0
    ? (suggestionContent.length > 150 
        ? suggestionContent.substring(0, 150) + '...'
        : suggestionContent)
    : 'This suggestion';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full border border-gray-200 animate-in fade-in zoom-in duration-200">
        <div className="p-6">
          <h3 className="text-xl font-black text-[#004876] mb-2">
            Delete Suggestion
          </h3>
          ...
          {suggestionContent && suggestionContent.length > 0 && (
            <p className="text-sm text-gray-700 mb-4 bg-gray-50 p-3 rounded-lg border border-gray-200 whitespace-pre-wrap break-words">
              {preview}
            </p>
          )}
